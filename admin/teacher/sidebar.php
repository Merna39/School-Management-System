  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        <!-- Dashboard -->
        <li class="nav-item">
          <a href="http://localhost/School-Management-System/admin/teacher/dashboard.php" class="nav-link">
        ...
        <li class="nav-item has-treeview">
          ...
          <li class="nav-item">
                <a href="http://localhost/School-Management-System/admin/teacher/classes.php" class="nav-link">
            ...
            <li class="nav-item">
              <a href="http://localhost/School-Management-System/admin/teacher/sections.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Sections</p>
              </a>
            </li>
            ...
            <!-- <li class="nav-item">
              <a href="http://localhost/School-Management-System/admin/teacher/lessons.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Lessons</p>
              </a>
            </li> -->
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="http://localhost/School-Management-System/admin/teacher/periods.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Periods</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="http://localhost/School-Management-System/admin/teacher/table-Level-1.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Time Table</p>
              </a>
            </li>
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="http://localhost/School-Management-System/admin/teacher/attendance.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Attendance</p>
              </a>
            </li>
        ...
        <!-- <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="<?= $site_url ?>teacher/examination-fee.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Examination Fee</p>
              </a>
            </li>
