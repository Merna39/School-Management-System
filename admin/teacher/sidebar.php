      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="http://localhost/School-Management-System/admin/teacher/timetable.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Time Table</p>
              </a>
            </li>
        ...
        <li class="nav-item has-treeview" id="communications-menu">
          <a href="http://localhost:8080/School-Management-System/admin/teacher_chat.php" class="nav-link">
