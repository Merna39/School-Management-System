  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar ">
    <div class="container" >
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent-7">
        ...
        <a href="login.php" class="nav-link dropdown-toggle " id="navbarDropdownMenuLink-333" data-toggle="dropdown"
      ...
      <div class="container ">
        ...
        <div class="row pt-lg-5 mt-lg-5 ">
          ...
          <div class="col-md-6 mb-5 mt-md-0 mt-5 white-text text-center text-md-left wow fadeInLeft"
            ...
            <hr class="hr-light">
            <h4 class="mb-3">See why over 1,500 schools worldwide trust our system to support the future of education.</h4>
...
<div style="height:300px; background: linear-gradient(-45deg ,#7986cb ,transparent 70%);">
  <div class="px-5 py-5 my-5 text-center ">
    <h1 class="display-5 fw-bold text-body-emphasis">What Makes <blaind class="font-weight-bolder" style="color : #283593">SMS</blaind> So Good...</h1>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-4">SMS Helps Administration, Students, Teachers & Parents Connect
         to Relevant Information on Education in one search.</p>
